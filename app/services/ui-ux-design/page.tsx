...
import commonStyles from './ui-ux-design-common.module.css';
import darkStyles from './ui-ux-design-dark.module.css';
import lightStyles from './ui-ux-design-light.module.css';
...
const service = {
  ...servicesData.find((s) => s.slug === 'ui-ux-design'),
  techs: ['Figma', 'Adobe XD', 'Sketch', 'InVision'],
};
const serviceCopy = servicePageCopy['ui-ux-design'];
