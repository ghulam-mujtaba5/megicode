...
export const metadata: Metadata = {
  ...
  description:
    'Replace manual work with AI-powered automation. Megicode builds intelligent workflow automation, AI chatbots, smart integrations, and process optimization for SMEs — saving businesses 100+ hours per month.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'Replace manual work with AI-powered automation — intelligent workflows, AI chatbots & smart integrations for SMEs.',
