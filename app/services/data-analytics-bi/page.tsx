...
const features = [
  { icon: <FaChartBar color="#4573df" size={36} title="Big Data Analytics" />, label: "Big Data Analytics" },
  { icon: <SiTableau color="#E97627" size={36} title="Tableau Visualization" />, label: "Tableau Visualization" },
  { icon: <FaCogs color="#4573df" size={36} title="Predictive Analytics" />, label: "Predictive Analytics" },
  { icon: <FaProjectDiagram color="#4573df" size={36} title="Data Warehousing" />, label: "Data Warehousing" },
];
...
export default function DataAnalyticsBIDetailPage() {
  ...
  return (
    <>
      ...
      {/* Hero Section - Full-width gradient, SVG, CTA */}
      <section
      ...
      <section style={{
        ...
        <div style={{ flex: 1, minWidth: 180, textAlign: 'center' }}>
          <img src="/Big Data Analytics.svg" alt="Analytics Overview" style={{ width: 160, maxWidth: '100%', borderRadius: 18, boxShadow: isDark ? '0 8px 32px #23294633' : '0 8px 32px #4573df22', background: palette.iconBg, padding: 18, border: `1.5px solid ${palette.iconBorder}` }} data-animate="fade-in" />
        </div>
      </section>
      ...
      <section style={{ margin: '3.2rem 0', animation: 'fadeInUp 1.3s cubic-bezier(.23,1.01,.32,1) both', color: palette.textMain }} data-animate="fade-in">
        ...
        <div style={{ display: 'flex', gap: 56, flexWrap: 'wrap' }}>
          ...
          >
            <span data-animate="countup" data-value="5x">5x</span>
            <div style={{ fontSize: '1.18rem', color: palette.textMain, fontWeight: 800, marginTop: 12 }}>ROI for companies using BI & analytics</div>
          </div>
          <div style={{ flex: 1, minWidth: 240, background: isDark ? 'linear-gradient(90deg, #232946 60%, #181c22 100%)' : 'linear-gradient(90deg, #e3e6ea 60%, #f7fafd 100%)', borderRadius: 26, padding: '2rem 2rem', textAlign: 'center', fontWeight: 900, color: palette.textAccent, fontSize: '2.4rem', marginBottom: 14, boxShadow: isDark ? '0 8px 32px #23294633' : '0 8px 32px #4573df11', border: `1.5px solid ${palette.border}`, transition: 'box-shadow 0.2s, transform 0.15s', backdropFilter: 'blur(2px)', filter: isDark ? 'drop-shadow(0 2px 12px #23294633)' : 'drop-shadow(0 2px 12px #4573df11)' }}
            onMouseOver={e => e.currentTarget.style.transform = 'scale(1.035)'}
            onMouseOut={e => e.currentTarget.style.transform = 'scale(1)'}
          >
            ...
            <div style={{ fontSize: '1.18rem', color: palette.textMain, fontWeight: 800, marginTop: 12 }}>of execs say analytics is critical to business</div>
          </div>
        </div>
      </section>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 32, alignItems: 'center' }}>
          ...
          {service.techs.map((t, i) => {
            ...
            switch (t.toLowerCase()) {
              ...
              case "power bi": imgSrc = "/meta/PowerBI.png"; useImg = true; break;
              case "tableau": Icon = SiTableau; color = "#E97627"; break;
              case "sql": Icon = SiApache; color = "#4479A1"; break;
              case "spark": Icon = SiApachekafka; color = "#E25A1C"; break;
              default:
                imgSrc = `/meta/${t.replace(/\s/g, '')}.png`;
                useImg = true;
                break;
            }
            // Fallback icon if image does not exist
            ...
            return (
              ...
              >
                {Icon ? (
                  ...
                  <FaCogs size={40} style={{ marginRight: 12 }} title={t} color={color || '#4573df'} />
                )}
                {t}
              </span>
            );
      ...
      >
        ...
        <div style={{ maxWidth: 900, margin: '0 auto', marginBottom: 32, color: palette.textSubtle, fontWeight: 600, fontSize: '1.13rem', textAlign: 'center' }}>
          We operate as your strategic partner—combining robust engagement models, agile execution, and enterprise-grade governance. Our operational workflow ensures risk-managed, transparent, and value-driven delivery: on time, on budget, and with full business visibility.
        </div>
        <div style={{
          display: 'grid',
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
              ...
              <div>
                ...
                <div style={{ color: palette.textSubtle, fontWeight: 600, fontSize: '0.99rem', marginTop: 2 }}>Iterative, sprint-based delivery with continuous improvement. CMMI L3+ for process maturity and global best practices in enterprise analytics.</div>
              </div>
            </div>
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
      ...
      <section style={{
        ...
        >
          <FaChartBar style={{ marginRight: 14, fontSize: '1.5rem', animation: 'pulse 2.2s infinite', verticalAlign: 'middle' }} title="Analytics Consultant" />
