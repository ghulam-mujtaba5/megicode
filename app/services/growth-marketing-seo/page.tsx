...
import { SiGoogleads, SiGoogleanalytics, SiHubspot, SiMeta, SiSemrush } from 'react-icons/si';
...
const serviceCopy = servicePageCopy['growth-marketing-seo'];

const engagementModels = [
  {
    title: 'Fixed Price',
    icon: <RiPriceTag3Fill size={40} />,
    benefits: ['Defined Campaign Scope', 'Predictable Budget', 'Milestone-Based Billing'],
    color: '#2d4fa2',
    isPopular: false,
  },
  {
    ...
    benefits: ['Ongoing Growth Support', 'Dedicated Marketing Team', 'Monthly Strategy Reviews'],
    color: '#4573df',
    isPopular: true,
  },
  {
    ...
    benefits: ['Pay for Results', 'Data-Driven Optimization', 'Transparent ROI Tracking'],
    color: '#ff9800',
    isPopular: false,
  },
];
...
const features = [
  {
    icon: <FaSearch color="#4573df" size={36} title="Technical SEO" />,
    label: 'Technical SEO & Site Optimization',
  },
  {
    icon: <FaPenFancy color="#4573df" size={36} title="Content Marketing" />,
    label: 'Content Marketing & Thought Leadership',
  },
  {
    icon: <FaBullhorn color="#4573df" size={36} title="Performance Marketing" />,
    label: 'Performance Marketing (Google & Meta)',
  },
  {
    icon: <FaChartLine color="#4573df" size={36} title="Conversion Rate Optimization" />,
    label: 'Conversion Rate Optimization (CRO)',
  },
  {
    icon: <FaChartBar color="#4573df" size={36} title="Analytics & Dashboards" />,
    label: 'Analytics Setup & Growth Dashboards',
  },
  {
    icon: <FaSeedling color="#4573df" size={36} title="Product Launch Strategy" />,
    label: 'Product Launch & Go-to-Market Strategy',
  },
];
  ...
  return (
    <div className={`${commonStyles.aiMLBoxSizingAll} ${themeStyles.main}`}>
      ...
      >
        ...
        <ServicePersonalizationPanel
          currentSlug="growth-marketing-seo"
        ...
        >
          <div className={commonStyles.overviewTextBlock}>
            ...
            <p className={`${commonStyles.overviewDesc} ${themeStyles.overviewDesc}`}>
              Most startups build great products but struggle to get users. We bridge that gap with
              growth marketing engineered for tech products - combining technical SEO,
              high-converting content, and data-driven paid campaigns. Every strategy is tied to
              measurable KPIs: traffic, signups, activation, and revenue.
            </p>
          </div>
          <div className={commonStyles.overviewImageBlock}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src="/icons/icon-megaphone.png"
              alt="Growth marketing and SEO"
              ...
              style={{
                ...
                height: 200,
                objectFit: 'contain',
                filter: 'drop-shadow(0 16px 40px rgba(255,152,0,0.22))',
              }}
            />
          </div>
        </section>
        ...
        >
          ...
          <div className={commonStyles.whyStatsRow}>
            <div className={`${commonStyles.whyStatCard} ${themeStyles.whyStatCard}`}>
              <span data-animate="countup" data-value="68">
                68%
              </span>
            ...
            <div className={`${commonStyles.whyStatCard} ${themeStyles.whyStatCard}`}>
              ...
              <div className={`${commonStyles.whyStatDesc} ${themeStyles.whyStatDesc}`}>
                lower customer acquisition cost with organic vs paid channels
              </div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', marginTop: '2.5rem' }}>
            ...
            <img
              ...
              alt="Growth chart - SEO and marketing results"
              width={140}
              height={140}
              loading="lazy"
              style={{
          ...
          <div className={commonStyles.techRow}>
            {service.techs.map((t, i) => {
              const techLogos: Record<string, React.ReactNode> = {
                'Google Analytics': (
                  <SiGoogleanalytics color="#E37400" size={32} title="Google Analytics" />
                ),
        ...
        <ServiceRecommendationPanel currentSlug="growth-marketing-seo" theme={theme} />
        <ServiceConversionPanel
          copy={serviceCopy}
          primaryCta={serviceCopy.primaryCta}
          onConsultationClick={openCalendly}
        ...
        >
          ...
          <div className={`${commonStyles.howDesc} ${themeStyles.howDesc}`}>
            Choose the working model that fits your growth targets, budget, and execution rhythm.
          </div>
        ...
        >
          ...
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src="/icons/icon-content-publish.png"
            alt=""
            width={72}
            height={72}
            loading="lazy"
