...
import commonStyles from './ai-saas-mvp-development-common.module.css';
import darkStyles from './ai-saas-mvp-development-dark.module.css';
import lightStyles from './ai-saas-mvp-development-light.module.css';
...
const service = {
  ...servicesData.find((s) => s.slug === 'ai-saas-mvp-development'),
  techs: ['Python', 'TensorFlow', 'PyTorch', 'Scikit-learn', 'AWS', 'Google Cloud', 'OpenAI'],
};
const serviceCopy = servicePageCopy['ai-saas-mvp-development'];
  ...
  return (
    <div className={`${commonStyles.aiMLBoxSizingAll} ${themeStyles.main}`}>
      ...
      >
        ...
        <ServicePersonalizationPanel
          currentSlug="ai-saas-mvp-development"
