...
const service = servicesData.find(s => s.slug === "custom-web-development");

const processSteps = [
  { title: "Requirement Analysis", desc: "Define goals & features.", icon: "/IconSystem/requirements.svg" },
  { title: "UI/UX Design", desc: "Wireframes & prototypes.", icon: "/IconSystem/design.svg" },
  { title: "Development & Testing", desc: "Build & QA.", icon: "/IconSystem/development.svg" },
  { title: "Deployment & Launch", desc: "Go live!", icon: "/IconSystem/deploy.svg" },
  { title: "Maintenance & Growth", desc: "Support & optimize.", icon: "/IconSystem/support.svg" }
];
  ...
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2.5rem 1rem', fontFamily: 'Inter, sans-serif' }}>
      ...
      <section style={{ display: 'flex', alignItems: 'center', gap: 32, flexWrap: 'wrap', marginBottom: 36 }}>
        <div style={{ flex: 1, minWidth: 260 }}>
          ...
          <div style={{ display: 'flex', gap: 12, marginTop: 10 }}>
            <span style={{ background: '#e3e6ea', color: '#4ea8ff', borderRadius: 8, padding: '0.3rem 1rem', fontWeight: 700, fontSize: '1.05rem' }}>Web</span>
            <span style={{ background: '#e3e6ea', color: '#4ea8ff', borderRadius: 8, padding: '0.3rem 1rem', fontWeight: 700, fontSize: '1.05rem' }}>Full Stack</span>
        ...
        <div style={{ flex: 1, minWidth: 220, textAlign: 'center' }}>
          <img src="/web app icon.svg" alt="Web App Illustration" style={{ width: 160, maxWidth: '100%', borderRadius: 24, boxShadow: '0 4px 24px #4ea8ff22' }} />
        </div>
      </section>
      ...
      <section style={{ margin: '48px 0 0 0', textAlign: 'center' }}>
        <a href="/contact" style={{ background: '#4ea8ff', color: '#fff', fontWeight: 800, fontSize: '1.18rem', borderRadius: 12, padding: '1rem 2.5rem', textDecoration: 'none', boxShadow: '0 2px 12px #4ea8ff33', transition: 'background 0.2s' }}>Start Your Web Project</a>
        <div style={{ marginTop: 10, color: '#3a4a5d', fontSize: '1.01rem' }}>Ready to build your next web app? Let’s talk about your vision.</div>
      </section>
    </main>
  );
}
