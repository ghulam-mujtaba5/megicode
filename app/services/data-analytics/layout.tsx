...
export const metadata: Metadata = {
  ...
  description:
    'Add AI superpowers to your existing product. Megicode integrates GPT-powered chatbots, smart search, recommendation engines, and AI-driven analytics into your software using OpenAI, Python & modern data stacks.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'Add AI superpowers to your existing product — GPT chatbots, smart search, recommendation engines & AI analytics.',
