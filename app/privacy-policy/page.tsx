    ...
    <div className={themeClass} style={{ minHeight: "100vh", width: "100vw", position: "relative", zIndex: 0, boxSizing: "border-box", transition: "background 0.3s" }}>
      ...
      <main className={styles.privacyMain}>
        ...
        <section className={styles.section}>
          ...
          <ul>
            <li><strong>Personal Information:</strong> If you contact us via forms or email (megicode@gmail.com), we collect your name, email address, and message content for communication purposes only.</li>
        ...
        <section className={styles.section}>
          ...
          <ul>
            ...
            <li>To respond to your inquiries or feedback sent to <a href="mailto:megicode@gmail.com">megicode@gmail.com</a>.</li>
        ...
        <section className={styles.section}>
          ...
          <ul>
            ...
            <li><strong>Email:</strong> <a href="mailto:megicode@gmail.com">megicode@gmail.com</a></li>
