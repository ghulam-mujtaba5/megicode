        ...
        {skillsData.map((category, index) => (
          ...
          >
            <header className={`${commonStyles.header} ${themeStyles.header}`}>
              ...
              />
              <h3 className={`${commonStyles.title} ${themeStyles.title}`}>{category.title}</h3>
            </header>
            ...
            <motion.div className={commonStyles.skillsGrid} variants={containerVariants}>
              {category.skills.map((skill, skillIndex) => (
                ...
                >
                  ...
                  <div className={commonStyles.skillContent}>
                    ...
                    <p
                      className={`${commonStyles.skillDescription} ${themeStyles.skillDescription}`}
                    >
                      {skill.description}
                    </p>
                  </div>
