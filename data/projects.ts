...
export const projects: Project[] = [
  {
    ...
    overview:
      "From zero online presence to Sheikhupura's first digital aesthetic clinic — a complete website and internal management system.",
    description:
    ...
    nextSteps:
      'Planned enhancements include automated SMS/WhatsApp appointment reminders, a patient self‑service portal for viewing treatment history and upcoming appointments, online payment integration for deposits, and AI‑powered content recommendations for the medical blog.',
    techStack: [
      'Next.js',
      'React',
      'Node.js',
    ...
    screenshots: ['/images/aesthetics-clinic.png'],
  },
  {
    ...
    nextSteps:
      "Expanding to all major Pakistani universities, launching AI‑powered study recommendations and smart past paper suggestions, integrating with university LMS systems, building a mobile app, and exploring AI tutoring features powered by the platform's massive academic content library.",
    techStack: [
      'Next.js',
      'React',
      'Node.js',
    ...
    screenshots: ['/images/campusaxis.png'],
  },
  {
    ...
    nextSteps:
      'Planned enhancements include A/B testing of hero messaging and CTA variants, a results/case‑study section as new client wins land, blog content targeting consultation‑scaling keywords for organic reach, and tighter analytics on the booking funnel to optimize conversion rate over time.',
